        ...
        <div className="custom-cara-lapor flex-column">
            ...
            <div className="container">
                ...
                <div class="card card-lapor">
                    <img class="card-img-top img-card-lapor" src="./asset/touch.png" alt="Card image cap"></img>
                    <div class="card-body">
                ...
                <div class="card card-lapor">
                    <img class="card-img-top img-card-lapor" src="./asset/contact-form.png" alt="Card image cap"></img>
                    <div class="card-body">
                ...
                <div class="card card-lapor">
                    <img class="card-img-top img-card-lapor" src="./asset/to-do-list.png" alt="Card image cap"></img>
                    <div class="card-body">
                ...
                <div class="card card-lapor">
                    <img class="card-img-top img-card-lapor" src="./asset/process.png" alt="Card image cap"></img>
                    <div class="card-body">
